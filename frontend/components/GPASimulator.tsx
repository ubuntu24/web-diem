    ...
    return (
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6 space-y-6">
            <div className="flex items-center gap-3 border-b border-slate-100 pb-4">
                ...
                <div>
                    <h3 className="font-bold text-slate-900">Tính điểm tích lũy dự kiến</h3>
                    <p className="text-sm text-slate-500">Thêm các môn học kỳ tới để xem GPA thay đổi thế nào</p>
                </div>
            </div>
                ...
                <div className="space-y-4">
                    <div className="flex gap-2">
                        <div className="flex-1">
                            <label className="block text-xs font-medium text-slate-500 mb-1">Tín chỉ</label>
                            <input
                                type="number"
                                value={newCredit}
                        ...
                        <div className="flex-1">
                            <label className="block text-xs font-medium text-slate-500 mb-1">Điểm (hệ 4)</label>
                            <input
                                type="number"
                                value={newScore}
                        ...
                        <div className="flex items-end">
                            <button
                                onClick={addSubject}
                                className="px-4 py-2 bg-slate-900 text-white rounded-lg hover:bg-slate-800 transition-colors flex items-center justify-center"
                            >
                    ...
                    <div className="space-y-2 max-h-48 overflow-y-auto pr-1">
                            ...
                            {subjects.map(sub => (
                                ...
                                >
                                    <div className="text-sm">
                                        ...
                                        <span className="text-slate-500">{sub.credit} tín</span>
                                    </div>
                        ...
                        {subjects.length === 0 && (
                            <p className="text-center text-sm text-slate-400 py-4 italic">Chưa có môn dự kiến nào</p>
                        )}
                    </div>
                </div>

                {/* Right: Result */}
                <div className="bg-indigo-600 rounded-xl p-6 text-white flex flex-col justify-center items-center text-center relative overflow-hidden">
                    <div className="absolute top-0 right-0 p-4 opacity-10">
                        <RefreshCw className="w-24 h-24" />
                    </div>

                    <div className="relative z-10">
                        <div className="text-indigo-200 text-sm font-medium mb-1 uppercase tracking-wider">GPA Tích Lũy Dự Kiến</div>
                        <div className="text-5xl font-bold mb-4 tracking-tight">
                            {projectedGPA}
                        </div>

                        <div className="inline-flex items-center gap-2 bg-indigo-500/50 px-3 py-1.5 rounded-full text-sm border border-indigo-400/30">
