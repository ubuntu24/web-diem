        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm p-6 space-y-6 transition-colors">
            <div className="flex items-center gap-3 border-b border-slate-100 dark:border-slate-700 pb-4">
                ...
                <div>
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400">Thêm các bản ghi kỳ tới để xem Performance thay đổi thế nào</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                    <div className="flex gap-2">
                        ...
                        <div className="flex-1">
                            <label className="block text-xs font-medium text-slate-500 dark:text-slate-400 mb-1">Performance (hệ 4)</label>
                            <input
                                type="number"
                                value={newScore}
                ...
                <div className="bg-indigo-600 dark:bg-indigo-900 rounded-xl p-6 text-white flex flex-col justify-center items-center text-center relative overflow-hidden ring-1 ring-inset ring-white/10 dark:ring-white/5 transition-colors shadow-lg">
                    ...
                    <div className="relative z-10">
                        <div className="text-indigo-200 dark:text-indigo-300 text-sm font-medium mb-1 uppercase tracking-wider">Performance tích lũy dự kiến</div>
