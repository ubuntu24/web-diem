...
def run_command(cmd, timeout=120):
    ...
    try:
        ...
        if result.returncode != 0:
            print(f"[!] Command failed ({result.returncode}): {result.stderr.strip()}")
...
def main():
    ...
    bandit_cmd = [
        ...
        "json",
        "-o",
        os.path.join(REPORTS_DIR, "bandit_report.json"),
    ]
    ...
    httpx_cmd = [
        ...
        "-title",
        "-o",
        os.path.join(REPORTS_DIR, "httpx_fe.txt"),
    ]
    ...
    katana_cmd = [
        ...
        TARGET_FE,
        "-o",
        os.path.join(REPORTS_DIR, "katana_paths.txt"),
    ]
    ...
    nuclei_cmd = [
        ...
        "-o",
        os.path.join(REPORTS_DIR, "nuclei_findings.txt"),
    ]
